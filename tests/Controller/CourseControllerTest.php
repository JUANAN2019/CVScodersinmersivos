...
class CourseControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'course[name]' => 'Testing',
            'course[dateStart]' => 'Testing',
            'course[dateEnd]' => 'Testing',
            'course[coders]' => 'Testing',
            'course[fkBootcamp]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setCoders('My Title');
        $fixture->setFkBootcamp('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'course[dateStart]' => 'Something New',
            'course[dateEnd]' => 'Something New',
            'course[coders]' => 'Something New',
            'course[fkBootcamp]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getCoders());
        self::assertSame('Something New', $fixture[0]->getFkBootcamp());
    }
