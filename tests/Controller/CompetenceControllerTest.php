...
class CompetenceControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'competence[name]' => 'Testing',
            'competence[fkLevel]' => 'Testing',
            'competence[coders]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'competence[name]' => 'Something New',
            'competence[fkLevel]' => 'Something New',
            'competence[coders]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getFkLevel());
